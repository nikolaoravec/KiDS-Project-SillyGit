...
public class BasicMessage implements Message {
	...
	public BasicMessage(MessageType type, int senderPort, String senderIp, int receiverPort,  String receiverIp, String messageText) {
		this.type = type;
		this.senderPort = senderPort;
		this.receiverPort = receiverPort;
		this.senderIp = senderIp;
	...
	public String toString() {
		return "[" + ChordState.chordHash(getSenderPort()+","+getSenderIp()) + "|" + getSenderPort() + "|" + getMessageId() + "|" +
					getMessageText() + "|" + getMessageType() + "|" +
					getReceiverPort() + "|" + ChordState.chordHash(getReceiverPort()+","+getReceiverIp()) + "]";
	}
